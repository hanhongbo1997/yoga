...
<div class="xui-container" style="margin:20px auto;">
    ...
    margin-bottom: 4px;background: #f8fafc!important;">
                ...
                <li class="xui-pull-l pro-cont">
                    <h2>
                        <a href="/siftclass/6935.html" target="_blank">[限时抢购] 瑜课堂丨超值VIP至尊视频年卡</a>
                ...
                <li class="xui-pull-r pro-price">
                    ...
                    <i class="xui-font-size-12" style="line-height: 90px;" >￥</i>3588.00</span>
                </li>
            </ul>
            <ul class="xui-bg-gary pro-order"  style="margin-bottom: 0;overflow: hidden;
    padding: 20px 30px;
    margin-bottom: 4px;background: #f8fafc!important;">
        ...
        <div class="xui-pay-box" style="width: 400px;">
            <div class="xui-pay-control" style="padding: 10px;" >
                ...
                <div class="xui-nature xui-text-left sui-text-warning" style="float: left;">
                    <em>￥</em>
                    <span id="total-price">3588.00</span>
        ...
        <div class="xui-pay-control" style="padding: 10px;">
            ...
            <div class="xui-nature xui-text-left sui-text-warning" style="float: left;">
                <em>￥</em>
                <strong class="xui-font-size-18" id="actual-price">3588.00</strong>
            </div>
            <div style="clear: both;"></div>
        </div>
        <div class="xui-pay-control" style="padding: 10px;">
        ...
        <div class="xui-pay-control" style="padding: 10px;">
            ...
            <div class="xui-nature xui-text-right">
                <a href="/home/order/order" class="sui-btn btn-xlarge btn-danger" id="paySubmit">提交订单</a>
            </div>
        </div>
        </div>
    </div>
