...
<script type="text/javascript" src="/home/js/login.js"></script>
    ...
    <div class="loginPage oh">
        <div class="fl club_show">
            <img src="http://wakeyoga.com/image/pc/clubBj.png">
        </div>
        <div class="fr login_method">
            <div class="method_nav3 tc">
                <span>忘<i>记密</i>码</span>
            </div>
            <!--账号登录-->
            <div class="dengluArea" style="display: block;">
            <form action="/home/logon/pass" method="post">
            {{ csrf_field() }}
                <ul class="loginList">
                    <li class="oh">
                    ...
                    <li class="oh registerLi">
                         <span class="fl"><a href="/home/register">立即注册</a></span>
                        <a href="/home/logon" class="fr">返回登录</a>
                    </li>
                    <li class="loginAcsess">
                        
                        <input type="submit" value="确定" style="font-size: 22px;">
                        ...
                        if(phone_preg.test(phone)){
                         //发送ajax
                                $.get('/home/logon/verification',{'phone':phone},function(msg){
                                        ...
                                        if(msg == 'success'){
                                            isPhone = false;
                                             $('.show_fi').eq(0).html('<font style="color:#71bd9c">手机号未注册</font>');
                                        }else{
                                            isPhone = true;
                                            $('.show_fi').eq(0).html('<font style="color:#fb9966"></font>');
                                        }
